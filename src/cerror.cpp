...
namespace pasc {
    std::unordered_map<error_code, std::string> code_repr {
        ...
        {eec_invalid_symbol, "invalid symbol"},
        {eec_exp_while, "expected \'WHILE\'"},
        {eec_exp_do, "expected \'DO\'"},
        {eec_invalid_type, "invalid type"},
        {eec_incompatible_types, "incompatible types"},
        {eec_unknown_identifier, "unknown indentifier"},
